    ...
    >
      <div
        className={cn(
          ...
          id === "pro" && "border-blue-600 gap-5 border-2"
        )}
      >
        <MotionDiv
          variants={listVariant}
        ...
        >
          <Link
            href={paymentLink}
            className={cn(
              "w-full rounded-full flex items-center justify-center gap-2 bg-gradient-to-r from-blue-800 to-blue-500 hover:from-blue-500 hover:to-blue-800 text-white border-2 py-2 transition-all",
              id === "pro"
                ? "border-blue-900"
